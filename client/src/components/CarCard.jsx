...
const Carcard = ({car}) => {
  ...
  return (
    <div onClick={()=>{navigate(`/car-details/${car._id}`);scrollTo(0,0)}} className='ground rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer'>
        ...
        <div className='relative h-48 overflow-hidden'>
            ...
            <div className='absolute bottom-4 right-4 bg-black/80 backdrop-blur-sm p-4 text-white px-3 py-2 rounded-lg'>
