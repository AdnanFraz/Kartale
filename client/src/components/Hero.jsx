...
const Hero = () => {
  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
      ...
      <form className='flex flex-col md:flex-row item-start md:item-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>

        <div className='flex flex-col md:flex-row item-start md-item-center gap-10 min-md:ml-8'>
