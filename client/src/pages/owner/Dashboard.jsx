...
const Dashboard = () => {
  ...
  const dashboardCards= [
    ...
    {title: "Pending",value: data.totalCars, icon:assets.cautionIconColored},
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard" subTitle="monitor overall platform performance inclucing total cars ,bookings, revenue,and recent activities"/>

      <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl'>
        {dashboardCards.map((card, index) => (
          <div key={index} className='flex gap-2 items-center justify-btween p-4 rounded-md border border-borderColor'>
            <div>
