                ...
                <div key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
                    ...
                    <div className='md:col-span-1'>
                        <div className='rounded-md overflow-hidden mb-3'>
                            <img src={booking.image} alt='' className='w-full h-auto aspect-video object-cover' />

                        </div>

                        <p className='text-lg font-medium mt-2'>{booking.brand} {booking.model}</p>

                        <p className='text-gray-500'>{booking.year} . {booking.category} . {booking.location}</p>
                    ...
                    <div className='md:col-span-2'>
                        ...
                        <div className='flex items-start gap-2 mt-3'>
                            <img src={assets.calendar_icon_colored} alt="" className='-4 h-4 mt-1'/>
                        ...
                        <div className='flex items-start gap-2 mt-3'>
                            <img src={assets.location_icon_colored} alt="" className='-4 h-4 mt-1'/>
